      ...
      >
        <div className="w-full md:w-2/4 xl:w-3/4 flex justify-center gap-5 items-center border border-neutral60 rounded-xl shadow-lg">
          <div className="w-full flex flex-col gap-4 p-4 xl:px-12 rounded-lg text-white">
            {alert.message && <AlertWindow message={alert.message} type={alert.type} />}

            <div className="flex flex-col items-center mb-4">
              <img src="/images/logo.svg" alt="Logo da Aplicação" className="w-32 h-32 xl:w-24 xl:h-24" />
            ...
            {!loading && step === 1 && (
              ...
              >
                ...
                <button type="submit" className="w-full bg-primary90 text-white p-3 rounded-full hover:bg-primary70">
                  Enviar código
                </button>
                <p className="text-center">
                  <Link to="/" className="text-primary60 underline">
                    <span className="text-primary60 underline cursor-pointer">Lembrou sua senha?</span>
                  </Link>
                </p>
              </form>
            )}
